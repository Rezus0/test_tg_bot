...
helptext5 = "Хочешь узнать информацию об учете индивидуальных достижений? Используй /achievements"
helptext6 = "Хочешь просмотреть видео с объяснением процедуры зачисления в ВУЗ? Используй /video"
helptext7 = "Хочешь узнать информацию о программах обучения в ВУЗе? Используй /programs"
helptext8 = "Хочешь узнать информацию о особых правах при приёме в ВУЗ? Используй /special"
helptext9 = "Хочешь узнать информацию о минимальных баллах, подтверждающее успешное прохождение вступительных испытаний? Используй /min_points"
helptext10 = "Хочешь узнать контактную информацию? Используй /contacts"
helptext11 = "Хочешь перейти в личный кабинет абитуриента? Используй /cabinet"
name = ""
surname = ""
middlename = ""
age = 0
