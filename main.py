...
def help_command(message):
    bot.send_message(message.from_user.id,
                     ...
                     helptext5 + "\n\n" + helptext6 + "\n\n" + helptext7 + "\n\n" + helptext8 + "\n\n" + helptext9 +
                     "\n\n" + helptext10 + "\n\n" + helptext11 + "\n\n" + helptext12 + "\n\n" + helptext13 + "\n\n" +
                     helptext14 + "\n\n" + helptext15 + helptext16 + "\n\n" + helptext17 + "\n\n" + helptext18 + "\n\n" + helptext19 + "\n\n" + helptext20, parse_mode="html")
...
helptext16 = "Хочешь узнать информацию о поликлинике РУТ(МИИТ)? Используй /clinic"
helptext17 = "Хочешь узнать информацию о группах университета в ВКонтакте? Используй /vk"
helptext18 = "Хочешь узнать информацию о конкурсе при поступлении? Используй /contest"
helptext19 = "Хочешь узнать информацию о преимуществах обучения? Используй /advantages"
helptext20 = "Хочешь узнать информацию о выплатах, установленных университетом? Используй /grants"
name = ""
surname = ""
middlename = ""
age = 0
